     ...
     <footer className="mt-24 px-6 md:px-16 lg:px-24 xl:px-32 w-full text-sm bg-slate-50 pt-10 border-t border-slate-200">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
                    <div className="sm:col-span-2 lg:col-span-1">
                        ...
                        <p className="text-sm/7 mt-6 text-slate-600">Manage and monitor your social media marketplace. Oversee brands, customers, and platform analytics with our comprehensive admin dashboard.</p>
                    </div>
                    <div className="flex flex-col lg:items-center lg:justify-center">
                        <div className="flex flex-col text-sm space-y-2.5">
                            <h2 className="font-semibold mb-5 text-slate-900">Admin Links</h2>
                            <a className="hover:text-indigo-600 transition text-slate-700" href="#">Dashboard</a>
                            <a className="hover:text-indigo-600 transition text-slate-700" href="#">Users Management</a>
                            <a className="hover:text-indigo-600 transition text-slate-700" href="#">Analytics</a>
                            <a className="hover:text-indigo-600 transition text-slate-700" href="#">Settings</a>
                            <a className="hover:text-indigo-600 transition text-slate-700" href="#">Reports</a>
                            <a className="hover:text-indigo-600 transition text-slate-700" href="#">Support</a>
                        </div>
                    </div>
                    <div>
                        <div className=" flex items-center justify-center bg-slate-100 rounded-lg px-1 py-2 gap-2 w-fit">
                        <h2 className="flex font-semibold text-slate-900  mb-">Flipearn</h2>
                            <Logger />
                        </div>
                        <div className="mt-6">
