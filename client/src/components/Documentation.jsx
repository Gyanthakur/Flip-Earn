	...
	const sections = [
		{
			...
			description:
				"The Home page is the entry point of FlipEarn. Here you can search for social media accounts by platform name (Instagram, YouTube, Twitter, etc.), explore featured and latest listings, and quickly navigate to Marketplace, Messages, and My Listings.",
			details: [
		...
		},
		{
			...
			description:
				"Sell your Social Accounts With Confidence & Earn Money. Clicking the Get Started Today button redirects you to the Marketplace page where all listings are displayed.",
			details: [
		...
		},
		{
			...
			description:
				"The Marketplace is where all social media account listings are displayed. Browse through various accounts, filter by your preferences, and find the perfect account to purchase.",
			details: [
		...
		},
		{
			...
			description:
				"When you click on a listing, you'll see the complete details page with all information about the social media account. This is where you can review everything before deciding to purchase.",
			details: [
		...
		},
		{
			...
			description:
				"Secure messaging system allows buyers and sellers to communicate directly. Build trust and resolve any questions before completing a transaction.",
			details: [
		...
		},
		{
			...
			description:
				"Follow these simple steps to purchase a social media account securely. The process is straightforward and designed to protect both buyers and sellers.",
			details: [
		...
		},
		{
			...
			description:
				"Follow these steps carefully to make your account visible to buyers. The process is simple and only takes a few minutes to complete.",
			details: [
		...
		},
		{
			...
			description:
				"This is a CRITICAL step. You must add credentials to your listing for admin approval. Without credentials, your listing will NOT be visible to buyers.",
			details: [
		...
		},
		{
			...
			description:
				"FlipEarn prioritizes the safety and security of all transactions. We have multiple safeguards in place to protect both buyers and sellers.",
			details: [
				...
				<div className="max-w-5xl mx-auto px-4 pb-20">
						...
						{sections.map((section) => {
							...
							return (
								<div key={section.id} className="group">
									{/* Card */}
									<div
										className={`relative border border-gray-200 rounded-lg bg-white overflow-hidden transition-all duration-300 shadow-sm hover:shadow-md ${
										...
										>
											...
											<div className="flex items-start justify-between">
												<div className="flex items-center gap-4 flex-1">
													<div
														className={`p-3 rounded-lg bg-gradient-to-r ${section.color} flex-shrink-0`}
													>
												...
												<ChevronDown
													className={`w-6 h-6 text-gray-400 transition-transform duration-300 flex-shrink-0 mt-1 ${
											...
											<div className="px-6 pb-6 pt-4 border-t border-gray-200">
												{section.important && (
													<div className="bg-red-50 border border-red-300 rounded-lg p-4 mb-6">
														...
														<p className="text-red-700 text-sm mt-2">
															Without completing this step, your listing will
															not be approved by admin.
														</p>
													</div>
												)}
												<ul className="space-y-3">
													{section.details.map((detail, idx) => (
														<li
															key={idx}
															className="flex gap-4 text-gray-700 text-base"
														>
															<span
																className={`text-xs flex-shrink-0 w-7 h-7 rounded-full flex items-center justify-center text-white font-bold bg-gradient-to-r ${section.color}`}
															>
																{idx + 1}
															</span>
					...
					<div className="mt-16 text-center p-8 rounded-xl border border-blue-200 bg-gradient-to-r from-blue-50 to-purple-50">
						...
						<p className="text-gray-600 max-w-2xl mx-auto mb-6 text-lg">
							Explore the marketplace, connect with traders, and start your
							journey today. All transactions are secure and verified.
						</p>
						<button
							onClick={() => {
