            ...
            <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-gray-800">
                ...
                <div className="flex items-center mt-24 md:mt-36">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-700"> Used by 1000+ users </p>
                    </div>
                </div>
                ...
                <p className="max-w-xl text-center text-base my-7">A secure marketplace to buy and sell Instagram, YouTube, Twitter, Telegram
and more - fast, safe and hassle-free.</p>
