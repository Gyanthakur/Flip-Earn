...
const DocumentationPage = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <Link to="/docs" className="flex items-center justify-center gap-2 mb-5 text-xl sm:text-2xl font-semibold
             text-violet-600 hover:text-blue-600 transition-all duration-150
             hover:scale-105">Docs 2</Link>

      <p className="text-center text-gray-600 max-w-3xl mx-auto mb-12">
        Learn how to use FlipEarn to buy and sell social media accounts securely,
        communicate with buyers and sellers, and complete transactions with confidence.
      </p>
      ...
      <section className="mb-16">
        ...
        <ul className="list-disc ml-6 mt-3 text-gray-700">
          <li>Search for social media accounts by platform name (Instagram, YouTube, Twitter, etc.).</li>
          <li>Explore featured and latest listings.</li>
          <li>Quickly navigate to Marketplace, Messages, and My Listings.</li>
        </ul>
        <p className="mt-3 text-gray-700">
          Simply type a platform name in the search input and click <b>Search</b>
      ...
      <section className="mb-16">
        ...
        <ul className="list-disc ml-6 mt-3 text-gray-700">
          ...
          <li>Click <b>More Details</b> to view full information.</li>
        </ul>
      </section>
      ...
      <section className="mb-16">
        ...
        <p className="mt-3 text-gray-700">
          Use the <b>Chat</b> button to talk with the seller before purchasing.
        </p>
      </section>

      {/* Chat */}
      <section className="mb-16">
        <h2 className="text-2xl font-semibold mb-4">💬 Chat & Communication</h2>
        <ul className="list-disc ml-6 mt-3 text-gray-700">
      ...
      {/* Selling - Detailed */}
      <section className="mb-16">
        <h2 className="text-2xl font-semibold mb-4">📤 How to Post Your Social Media Account for Sale</h2>
        <p className="text-gray-700 leading-relaxed">
        ...
        <ol className="list-decimal ml-6 mt-4 text-gray-700 space-y-2">
          ...
          <li>Go to <b>My Listings</b> from the navigation bar.</li>
          <li>Click on the <b>New Listing</b> button (shown in the first image).</li>
          <li>
            Fill all the details shown in the listing form (second image), such as:
          ...
          <li>After filling all details, click on the <b>Create Listing</b> button.</li>
        </ol>
      </section>
      ...
      <section className="mb-16">
        ...
        <ul className="list-disc ml-6 text-gray-700 space-y-2">
          <li>
            After creating the listing, you will see a <b>lock icon</b> on your listing.
          </li>
          <li>
            Hover over or click the lock icon and select <b>Add Credentials</b>.
          </li>
          <li>
            <b>If you do not add credentials, the admin will NOT approve your listing.</b>
          </li>
          <li>
          ...
          <li>
            If available, always upload <b>images/screenshots</b> as proof to increase trust.
          </li>
        </ul>
      </section>
      ...
      <section>
       ...
       {/* CTA Section */}
        <div className="mt-16 text-center p-8 rounded-xl  border-blue-200">
          ...
          <button onClick={()=> {navigate('/create-listing'); scrollTo(0,0)}} className="px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-lg hover:shadow-lg hover:shadow-blue-400/50 transition-all duration-300 transform hover:scale-105">
            Sell your Platform
          </button>
        </div>
    </div>
