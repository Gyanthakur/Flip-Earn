...
import { addCredential, addListing, deleteUserListing, getAllPublicListing, getAllUserListing, getAllUsersOrders, markFeatured, purchaseAccount, toggleStatus, updateListing, withdrawAmount } from '../controllers/listingController.js';
...
listingRouter.get('/user-orders', protect, getAllUsersOrders)
